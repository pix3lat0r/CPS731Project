...
3),
isDisplayed()));
        appCompatEditText2.perform(replaceText("jack@gmail.com"), closeSoftKeyboard());
...
allOf(withId(R.id.name), withText("Jack"),
withParent(withParent(withId(android.R.id.content))),
isDisplayed()));
        editText.check(matches(withText("Jack")));
        
        ViewInteraction editText2 = onView(
allOf(withId(R.id.email), withText("jack@gmail.com"),
withParent(withParent(withId(android.R.id.content))),
isDisplayed()));
        editText2.check(matches(withText("jack@gmail.com")));
